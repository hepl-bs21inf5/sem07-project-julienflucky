<template>
  <div class="container mt-3">
    <h1>BS21INF5 Programmation Web et bases de données</h1>
    <p>
      Acquérir les compétences de base nécessaires pour concevoir et réaliser des applications Web
      statiques et dynamiques avec HTML, CSS et JavaScript en utilisant une base de données
      PostgreSQL.
    </p>

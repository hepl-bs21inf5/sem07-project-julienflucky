    ...
    <form @submit="submit">
      ...
      <div class="form-check">
        <input
          ...
          value="blanc"
        />
        <label class="form-check-label" for="chevalBlanc">3</label>
      </div>
      <div class="form-check">
        <input
          id="chevalBrun"
          ...
          value="brun"
        />
        <label class="form-check-label" for="chevalBrun">4</label>
      </div>
      <div class="form-check">
        <input
          id="chevalNoir"
          ...
          value="noir"
        />
        <label class="form-check-label" for="chevalNoir">5</label>
      </div>
      <button
        class="btn btn-primary"
        :class="{ disabled: !filled }"
